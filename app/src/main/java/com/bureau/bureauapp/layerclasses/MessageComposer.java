...
public class MessageComposer extends FrameLayout {
    ...
    /**
     * Prepares this PavanAtlasMessageComposer for use.
     *
     * @return this PavanAtlasMessageComposer.
     */
    public MessageComposer init(LayerClient layerClient, ParticipantProvider participantProvider) {
        ...
        mAttachButton.setImageResource(R.drawable.ic_attach_file);
    ...
    /**
     * Adds AttachmentSenders to this PavanAtlasMessageComposer's attachment menu.
     *
     * @param senders AttachmentSenders to add to this PavanAtlasMessageComposer's attachment menu.
     * @return This PavanAtlasMessageComposer.
     */
