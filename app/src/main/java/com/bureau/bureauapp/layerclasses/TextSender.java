...
//        String myName = getParticipantProvider().getParticipant(getLayerClient().getAuthenticatedUserId()).getName();
        String myName = AppData.getString(getContext(), BureauConstants.firstName);//+"&"+getParticipantProvider().getParticipant(getLayerClient().getAuthenticatedUserId()).getName();
