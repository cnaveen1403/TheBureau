                ...
                for (int i = 0; i < barcodes.size(); i++) {
                    ...
                    try {
                        ...
                        if (!appId.getScheme().equals("layer")) {
                            throw new IllegalArgumentException("URI is not an MyApplication ID");
                        }
                        ...
                        if (Log.isLoggable(Log.VERBOSE)) {
                            Log.v("Captured Layer MyApplication ID: " + appId + ", UUID: " + uuid);
                        }
                        ...
                        if (Log.isLoggable(Log.ERROR)) {
                            Log.e("Barcode does not contain an MyApplication ID URI: " + value, e);
                        }
                    }
                }
            }
