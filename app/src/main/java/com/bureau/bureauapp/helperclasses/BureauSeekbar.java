...
public class BureauSeekbar extends View {
    ...
    public BureauSeekbar(Context context) {
        this(context, null);
    }

    public BureauSeekbar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BureauSeekbar(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public BureauSeekbar setCornerRadius(float cornerRadius) {
        this.cornerRadius = cornerRadius;
        return this;
    }

    public BureauSeekbar setMinValue(float minValue) {
        this.minValue = minValue;
        this.absoluteMinValue = minValue;
        return this;
    }

    public BureauSeekbar setMaxValue(float maxValue) {
        this.maxValue = maxValue;
        this.absoluteMaxValue = maxValue;
        return this;
    }

    public BureauSeekbar setMinStartValue(float minStartValue) {
        this.minStartValue = minStartValue;
        return this;
    }

    public BureauSeekbar setSteps(float steps) {
        this.steps = steps;
        return this;
    }

    public BureauSeekbar setBarColor(int barColor) {
        this.barColor = barColor;
        return this;
    }

    public BureauSeekbar setBarHighlightColor(int barHighlightColor) {
        this.barHighlightColor = barHighlightColor;
        return this;
    }

    public BureauSeekbar setLeftThumbColor(int leftThumbColorNormal) {
        this.leftThumbColorNormal = leftThumbColorNormal;
        return this;
    }

    public BureauSeekbar setLeftThumbHighlightColor(int leftThumbColorPressed) {
        this.leftThumbColorPressed = leftThumbColorPressed;
        return this;
    }

    public BureauSeekbar setLeftThumbDrawable(int resId) {
        setLeftThumbDrawable(ContextCompat.getDrawable(getContext(), resId));
        return this;
    }

    public BureauSeekbar setLeftThumbDrawable(Drawable drawable) {
        setLeftThumbBitmap(getBitmap(drawable));
        return this;
    }

    public BureauSeekbar setLeftThumbBitmap(Bitmap bitmap) {
        leftThumb = bitmap;
        return this;
    }

    public BureauSeekbar setLeftThumbHighlightDrawable(int resId) {
        setLeftThumbHighlightDrawable(ContextCompat.getDrawable(getContext(), resId));
        return this;
    }

    public BureauSeekbar setLeftThumbHighlightDrawable(Drawable drawable) {
        setLeftThumbHighlightBitmap(getBitmap(drawable));
        return this;
    }

    public BureauSeekbar setLeftThumbHighlightBitmap(Bitmap bitmap) {
        leftThumbPressed = bitmap;
        return this;
    }

    public BureauSeekbar setDataType(int dataType) {
        this.dataType = dataType;
        return this;
    }

    public BureauSeekbar setPosition(int pos) {
    ...
    protected final int getPosition(final TypedArray typedArray) {
        final int pos = typedArray.getInt(R.styleable.BureauRangeSeekbar_position, Position.LEFT);
